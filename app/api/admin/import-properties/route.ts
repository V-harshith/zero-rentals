        ...
        for (const [index, row] of (data as Record<string, unknown>[]).entries()) {
            try {
                ...
                const propertyData = {
                    ...
                    one_rk_price: row.one_rk_price ? parseFloat(String(row.one_rk_price)) : null,
                    ...
                    triple_sharing_price: getVal(['triple_sharing_price', 'Triple Sharing', 'TrippleSharing']) ? parseFloat(String(getVal(['triple_sharing_price', 'Triple Sharing', 'TrippleSharing']))) : null,
