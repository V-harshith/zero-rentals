                                ...
                                <div className="relative h-64 sm:h-80 md:h-96 bg-gray-200 rounded-t-lg flex items-center justify-center overflow-hidden group">
                                    ...
                                    <div className="absolute top-4 left-4 flex gap-2 z-10">
                                        ...
                                        {property.adminFeatured && (
                                            <Badge className="bg-yellow-500">Admin Pick</Badge>
                                        )}
                                        {property.featured && (
                                        ...
                                        <div className={`grid grid-cols-4 gap-2 p-4 ${!user ? 'blur-md' : ''}`}>
                                            {property.images.slice(0, 4).map((img, i) => (
                                                <div
                                                    ...
                                                    className={`relative h-20 bg-gray-100 rounded overflow-hidden ${user ? 'cursor-pointer hover:opacity-75 transition-all' : 'cursor-not-allowed'
