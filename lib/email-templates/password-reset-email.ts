...
<body>
  <div class="container">
    ...
    <div class="content">
      ...
      <p>We received a request to reset the password for your ZeroRentals account. Click the button below to choose a new password.</p>
      ...
      <div class="warning">
        ...
        <p style="margin-top: 5px;">For security reasons, this link can only be used once.</p>
      </div>
